...
const LegacySpellListDetails = () => {
  ...
  return (
    <Container className="pt-3 mb-4 m-1">
      <Alert
        className="d-flex alert-warning"
        dismissible
        >
        <div className="d-flex flex-column">
          <span>This list is out of date with the current rulebook versions and cannot be edited.</span>
          <span>To have an up to date list, create a new one!</span>
          <div
...
export default LegacySpellListDetails
